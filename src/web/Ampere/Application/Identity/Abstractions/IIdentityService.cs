...
namespace Ampere.Application.Identity.Abstractions;
...
public interface IIdentityService
{
    ...
    /// <summary>
    /// Any method implementation over Users Set 
    /// </summary>
    /// <typeparam name="T">An <see cref="T"/> user instance.</typeparam>
    /// <param name="expression">The lambda expression that queries this set</param>
    /// <returns>An <see cref="bool"/> value representing the result.</returns>
    bool Any (Func<User, bool> expression);
 }
